...
public class AdminSetDaohuoAdapter extends BaseExpandableListAdapter {
    ...
    public AdminSetDaohuoAdapter(Context context, List<Map<String,Object>> pdata, List<List<Map<String,Object>>> mdata){
        this.pdata=pdata;
        this.mdata=mdata;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        convertView=mInflater.inflate(R.layout.fragment_admin_third_plist_item,null);
        ...
        holder.daohuoBtn=convertView.findViewById(R.id.daohuoBtn);
        holder.daohuoBtn.setTag(groupPosition);
        ...
        holder.daohuoBtn.setOnClickListener(clickListener);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView=mInflater.inflate(R.layout.fragment_admin_third_clist_item,null);
